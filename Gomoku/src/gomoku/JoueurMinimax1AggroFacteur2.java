...
public class JoueurMinimax1AggroFacteur2 extends JoueurMinimax1 {

	public JoueurMinimax1AggroFacteur2(Grille g, String nom, boolean isCroix) {
		super(g, nom, isCroix);
		// TODO Auto-generated constructor stub
	}

	public JoueurMinimax1AggroFacteur2(Grille g, boolean isCroix) {
		super(g, isCroix);
		// TODO Auto-generated constructor stub
	}
	...
	public int minimax(char[][] etat, int depth, int depth2, boolean isMax) {
		int score = evaluateAggroFacteur2(etat);
	 ...
	 * 
	 * Le score de l'adversaire est multiplié par 2.
	 * 
	 * @param etat
	 * @return le score correspondant à l'etat donné, MaxPlayer=Croix,
	 *         MinPlayer=Ronds
	 */
	public int evaluateAggroFacteur2(char[][] etat) {
...
//					break;
	...
	public static void main(String[] args) {
		...
		JoueurMinimax1 j1 = new JoueurMinimax1(maGrille, "minimax" , true);
		JoueurMinimax1 j2 = new JoueurMinimax1AggroFacteur2(maGrille, "minimax1Aggro2" , false);
