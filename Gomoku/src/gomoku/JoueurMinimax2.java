...
public class JoueurMinimax2 extends JoueurMinimax1 {

	public JoueurMinimax2(Grille g, String nom, boolean isCroix) {
		super(g, nom, isCroix);
		// TODO Auto-generated constructor stub
	}

	public JoueurMinimax2(Grille g, boolean isCroix) {
	 ...
	 *         MinPlayer=Ronds
	 */
	public static int evaluate2(char[][] etat) {
	...
	public static void main(String[] args) {
		...
		JoueurMinimax1 minimax1 = new JoueurMinimax2(maGrille, "minimax1" , true);
		JoueurMinimax2 minimax2 = new JoueurMinimax2(maGrille, "minimax2" , false);

		minimax2.jouerAvec(minimax1);
	}
}
