...
public class JoueurMinimax1AggroFacteur3 extends JoueurMinimax1 {

	public JoueurMinimax1AggroFacteur3(Grille g, String nom, boolean isCroix) {
		super(g, nom, isCroix);
		// TODO Auto-generated constructor stub
	}

	public JoueurMinimax1AggroFacteur3(Grille g, boolean isCroix) {
		super(g, isCroix);
		// TODO Auto-generated constructor stub
	}
	...
	public int minimax(char[][] etat, int depth, int depth2, boolean isMax) {
		int score = evaluateAggroFacteur3(etat);
	 ...
	 *         MinPlayer=Ronds
	 */
	public int evaluateAggroFacteur3(char[][] etat) {
